...
<div class="laporan-header">
    ...
    <p class="laporan-subtitle">
        Menampilkan seluruh data bahan baku yang digunakan dalam proses produksi Kue Kering Jeanette.
    </p>
    ...
    <div class="col-md-4">
        ...
        <div class="stat-card-report">
            ...
            <div class="stat-value">
                ...
                <?= array_sum(array_column($bahanbaku, 'Stok')) ?>
    ...
    <div class="col-md-4">
        ...
        <div class="stat-card-report">
            ...
            <div class="stat-value">
                ...
                <?= count(array_unique(array_column($bahanbaku, 'Merk'))) ?>
...
<div class="card card-laporan">
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
            ...
            <div>
                ...
                <p class="section-subtitle">
                    Kelola dan cetak laporan data bahan baku
                </p>
            ...
            <div>
                ...
                <button
                    ...
                    onclick="window.open('<?= base_url('laporanbahanbaku/cetak') ?>','_blank')">
    ...
    <div class="card-body">
            ...
            <div class="col-md-5">
                ...
                <div class="search-box">
                    ...
                    <input
                        ...
                        id="search-input"
                        class="form-control"
                        placeholder="Cari ID, nama bahan, atau merk...">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-laporan align-middle" id="databahan">
...
<script>
    ...
    searchInput.addEventListener('keyup', function () {
        ...
        let rows = document.querySelectorAll('#databahan tbody tr');
        ...
        rows.forEach(row => {
            ...
            let merk = row.cells[3]?.innerText.toLowerCase() || '';
            let satuan = row.cells[4]?.innerText.toLowerCase() || '';
            let stok = row.cells[5]?.innerText.toLowerCase() || '';
            let harga = row.cells[6]?.innerText.toLowerCase() || '';
