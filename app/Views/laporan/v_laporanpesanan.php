...
<div class="laporan-header">
    ...
    <p class="laporan-subtitle">
        Menampilkan seluruh data pesanan pelanggan berdasarkan status maupun periode.
    </p>
...
<div class="card card-laporan">
        ...
        <div class="d-flex flex-column gap-3">
            ...
            <div>
                ...
                <p class="section-subtitle">
                    Kelola dan cetak laporan data pesanan berdasarkan status dan periode.
                </p>
            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <button
                            type="button"
                            class="btn btn-warning btn-cetak"
                            onclick="cetakPesanan('Menunggu')">
                        ...
                        <button
                            type="button"
                            class="btn btn-primary btn-cetak"
                            onclick="cetakPesanan('Diproses')">
                        ...
                        <button
                            ...
                            onclick="cetakPesanan('Dibatalkan')">
    ...
    <div class="card-body">
            ...
            <div class="col-md-5">
                ...
                <div class="search-box">
                    ...
                    <input
                        ...
                        id="search-input"
                        class="form-control"
                        placeholder="Cari ID pesanan, pelanggan, atau tanggal...">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-laporan align-middle" id="datapesanan">
                        ...
                        <?php foreach ($pesanan as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <span class="badge bg-<?= $badge[$row['StatusPesanan']] ?>">
...
searchInput.addEventListener('keyup', function () {
    ...
    rows.forEach(row => {
        ...
        let estimasi = row.cells[4]?.innerText.toLowerCase() || '';
        let total = row.cells[5]?.innerText.toLowerCase() || '';
