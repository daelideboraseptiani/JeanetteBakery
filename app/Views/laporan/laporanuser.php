...
<body onload="window.print()">
    ...
    <div class="header">
        ...
        <div class="header-content">
            ...
            <div class="logo">
                <img src="<?= base_url('assets/img/logo.jpeg') ?>" alt="Logo Jeanette">
            </div>
            ...
            <?php if (!empty($user)) : ?>
                ...
                <?php foreach ($user as $row) : ?>
                    ...
                    <tr>
                        ...
                        <td><?= esc($row['IdUser']); ?></td>
                        <td><?= esc($row['NamaLengkap']); ?></td>
                        <td><?= esc($row['Username']); ?></td>
                        <td><?= esc($row['Email']); ?></td>
                        <td class="center"><?= esc($row['Role']); ?></td>
                        <td class="center"><?= esc($row['Status']); ?></td>
                    </tr>
