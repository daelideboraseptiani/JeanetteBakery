...
<div class="laporan-header">
    ...
    <p class="laporan-subtitle">
        ...
        Menampilkan seluruh transaksi penjualan yang telah terverifikasi.
...
<div class="card card-laporan">
        ...
        <div class="d-flex flex-column gap-3">
            ...
            <div>
                ...
                <p class="section-subtitle">
                    Cetak laporan penjualan berdasarkan periode transaksi yang telah terverifikasi.
                </p>
    ...
    <div class="card-body">
            ...
            <div class="col-md-5">
                ...
                <div class="search-box">
                    ...
                    <input
                        ...
                        id="search-input"
                        class="form-control"
                        placeholder="Cari ID pembayaran, pesanan, pelanggan...">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-laporan align-middle" id="datapenjualan">
...
function cetakPenjualan()
{
    ...
    let url = "<?= base_url('laporanpenjualan/cetak') ?>?";

    if (tglAwal !== '') {

        url += "tgl_awal=" + encodeURIComponent(tglAwal);
...
searchInput.addEventListener('keyup', function () {
    ...
    let rows = document.querySelectorAll('#datapenjualan tbody tr');
    ...
    rows.forEach(row => {
        ...
        let idPesanan    = row.cells[2]?.innerText.toLowerCase() || '';
        let pelanggan    = row.cells[3]?.innerText.toLowerCase() || '';
        let tanggal      = row.cells[4]?.innerText.toLowerCase() || '';
        let jenis        = row.cells[5]?.innerText.toLowerCase() || '';
        let metode       = row.cells[6]?.innerText.toLowerCase() || '';
        let total        = row.cells[7]?.innerText.toLowerCase() || '';
