...
<style>
    ...
    .stat-card-report:hover {
        ...
        box-shadow: 0 10px 24px rgba(244, 182, 196, 0.18);
    }
    ...
    .stat-icon.total { background: #fcecef; color: #c86b85; }
    .stat-icon.aktif { background: #eaf7ee; color: #2e7d32; }
    .stat-icon.nonaktif { background: #fdeaea; color: #c62828; }
    ...
    .card-laporan {
        ...
        border-radius: 20px;
        overflow: hidden;
        box-shadow: 0 8px 28px rgba(92, 61, 46, 0.08);
    }
    ...
    .search-box input:focus {
        border-color: #d96c8a;
        box-shadow: 0 0 0 0.2rem rgba(217, 108, 138, 0.15);
    }
</style>
...
<div class="brand-mini">
    <img src="<?= base_url('assets/logo/logo-jeanette.png') ?>" alt="Jeanette Logo">

    <div>
        <div class="brand-name">Kue Kering Jeanette</div>
        <small class="text-muted">Sistem Informasi Produksi & Penjualan</small>
    </div>
</div>

<h1 class="laporan-title">Laporan Data User</h1>

<p class="laporan-subtitle">
    Menampilkan seluruh data pengguna sistem Kue Kering Jeanette beserta status dan hak aksesnya.
</p>
...
<div class="col-md-4">
    <div class="stat-card-report">
        ...
        <div class="stat-value">
            <?= count(array_filter($user, fn($u) => $u['Status'] == 'Nonaktif')) ?>
        </div>
...
<div class="card-header card-header-laporan">
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        ...
        <div>
            <h3 class="section-title">Daftar User Sistem</h3>
            <p class="section-subtitle">Kelola dan cetak laporan data user berdasarkan status pengguna</p>
        </div>
        ...
        <div class="d-flex flex-wrap gap-2 justify-content-lg-end">
            ...
            <button
                ...
                onclick="window.open('<?= base_url('laporanuser/cetak?status=Aktif') ?>','_blank')">
            ...
            <button
                ...
                onclick="window.open('<?= base_url('laporanuser/cetak?status=Nonaktif') ?>','_blank')">
            ...
            <button
                ...
                onclick="window.open('<?= base_url('laporanuser/cetak') ?>','_blank')">
...
<div class="card-body">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-laporan align-middle" id="datauser">
