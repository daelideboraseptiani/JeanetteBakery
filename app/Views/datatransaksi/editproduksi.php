...
<div class="card card-pengguna">
    ...
    <div class="card-header card-header-pengguna">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <h3>Edit Produksi</h3>
                <small>Perbarui data produksi dan penggunaan bahan baku</small>
            </div>
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('dataproduksi/update') ?>" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input
                        ...
                        name="TglProduksi"
                        class="form-control"
                        value="<?= old('TglProduksi', $produksi['TglProduksi']) ?>"
                        required>
                    ...
                    <select name="IdProduk" class="form-select" required>
                        ...
                        <?php foreach ($produk as $p) : ?>
                            ...
                            <option value="<?= $p['IdProduk'] ?>"
                                <?= old('IdProduk', $produksi['IdProduk']) == $p['IdProduk'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="StatusProduksi" class="form-select" required>
                        ...
                        <option value="Diproduksi"
                            <?= old('StatusProduksi', $produksi['StatusProduksi']) == 'Diproduksi' ? 'selected' : '' ?>>
                        ...
                        <option value="Selesai"
                            <?= old('StatusProduksi', $produksi['StatusProduksi']) == 'Selesai' ? 'selected' : '' ?>>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input
                        ...
                        name="JumlahProduksi"
                        class="form-control"
                        value="<?= old('JumlahProduksi', $produksi['JumlahProduksi']) ?>"
                        min="0"
                        required>

                    <small class="text-muted">
                        Contoh: 5.00 kg adonan.
                    </small>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input
                        ...
                        name="HasilProduksi"
                        class="form-control"
                        value="<?= old('HasilProduksi', $produksi['HasilProduksi']) ?>"
                        min="0"
                        required>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    ...
                    <small class="text-muted">
                        Tambahkan, ubah, atau hapus bahan baku untuk produksi ini.
                    </small>
                </div>
                                ...
                                <select name="IdBahanBaku[]" class="form-select">
                                    ...
                                    <?php foreach ($bahan as $b) : ?>
                                        ...
                                        <option value="<?= $b['IdBahanBaku'] ?>"
                                            <?= $d['IdBahanBaku'] == $b['IdBahanBaku'] ? 'selected' : '' ?>>
                ...
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Perubahan bahan baku akan menyesuaikan stok secara otomatis.</li>
                            <li>Stok lama akan dikembalikan terlebih dahulu sebelum stok baru dikurangi.</li>
                            <li>Proses menggunakan database transaction sehingga data tetap konsisten.</li>
...
<script>
    ...
    window.addEventListener('load', function() {
        ...
        document.querySelector('select[name="IdProduk"]').focus();
