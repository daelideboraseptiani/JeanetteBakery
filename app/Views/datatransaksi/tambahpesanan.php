...
<div class="card-header card-header-pengguna">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            ...
            <small>Buat transaksi pesanan pelanggan</small>
        </div>
...
<div class="card-body">
    ...
    <form action="<?= base_url('datapesanan/simpan') ?>" method="post" id="form-pesanan">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                ...
                <small class="text-muted">
                    Tambahkan produk kemasan yang dipesan pelanggan
                </small>
            </div>
