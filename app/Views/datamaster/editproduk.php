...
<div class="card-header card-header-pengguna">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <h3>Edit Produk</h3>
            <small>Perbarui data produk kue kering</small>
        </div>
...
<div class="card-body">
    ...
    <form action="<?= base_url('dataproduk/update') ?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="StatusProduk" class="form-select" required>
                    ...
                    <option value="Aktif"
                        <?= old('StatusProduk', $produk['StatusProduk']) == 'Aktif' ? 'selected' : '' ?>>
                    ...
                    <option value="Nonaktif"
                        <?= old('StatusProduk', $produk['StatusProduk']) == 'Nonaktif' ? 'selected' : '' ?>>
            ...
            <div class="col-12 mb-3">
                ...
                <small class="text-muted">
                    Deskripsi dapat diubah kapan saja sesuai informasi produk terbaru.
                </small>
